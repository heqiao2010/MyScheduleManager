...
public class AlarmProvider extends ContentProvider {
	...
	static {
		sURLMatcher.addURI("com.example.scheldulemanager", "alarm", ALARMS);
		sURLMatcher
				.addURI("com.example.scheldulemanager", "alarm/#", ALARMS_ID);
	}
	...
	public static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.execSQL("CREATE TABLE alarms (" + "_id INTEGER PRIMARY KEY,"
					...
					+ "daysofweek INTEGER, " + "alarmtime BIGINT, "
					+ "enabled INTEGER, " + "vibrate INTEGER, "
					+ "message TEXT, " + "alert TEXT, "
					+ "category INTEGER, " 
					+ "sort_key CHAR[5]);"); //Label的首字符拼音
		}

		@Override
		public void onUpgrade(SQLiteDatabase db, int oldVersion,
				int currentVersion) {
			Log.v("main", "Upgrading alarms database from version "
	...
	public Uri insert(Uri url, ContentValues initialValues) {
		...
		Log.v("main", "Added alarm rowId = " + rowId);
