...
//    static class ScreenOffHandler extends Handler {
//		WeakReference<AlarmAlert> mAlarmAlert;
//		ScreenOffHandler(AlarmAlert activity) {
//			mAlarmAlert = new WeakReference<AlarmAlert>(activity);
//		}
//		@Override
//		public void handleMessage(Message msg) {
//			AlarmAlert theActivity = mAlarmAlert.get();
//			theActivity.handleScreenOff((KeyguardManager) msg.obj);
//		}
//    }
...
//        mHandler = new ScreenOffHandler(this);
    }
