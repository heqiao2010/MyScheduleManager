...
public final class Alarm implements Parcelable {
    ...
    public static class Columns implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =
                Uri.parse("content://com.example.scheldulemanager/alarm");
        ...
        /**
         * Month in localtime 1 - 12
         * <P>Type: INTEGER</P>
         */
        public static final String MONTH = "month";
        
        /**
         * Day of month in localtime 0 - 59
         * <P>Type: INTEGER</P>
         */
        ...
        static final String[] ALARM_QUERY_COLUMNS = {
            _ID, YEAR, MONTH, DAY, HOUR, MINUTES, DAYS_OF_WEEK, ALARM_TIME,
        ...
        public static final int ALARM_CATEGORY_INDEX = 12;
        public static final int ALARM_SORT_KEY_INDEX = 13;
    }
    //////////////////////////////
    // End 每一列定义结束
    //////////////////////////////
    ...
    public Alarm(Cursor c) {
        ...
        category = c.getInt(Columns.ALARM_CATEGORY_INDEX);
    ...
    public Alarm() {
        ...
        month= c.get(Calendar.MONTH) + 1;  //calendar 中month范围0-11
